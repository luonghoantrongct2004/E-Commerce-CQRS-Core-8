...
public class ProductDisableEventHandler : INotificationHandler<ProductDisableEvent>
{
    private readonly IReadUnitOfWork _readUnitOfWork;
    private readonly ProductService _productService;

    public ProductDisableEventHandler(IReadUnitOfWork readUnitOfWork,
    ...
    public async Task Handle(ProductDisableEvent notification, CancellationToken cancellationToken)
    {
