...
public class DisableProductCommandHandler : IRequestHandler<DisableProductCommand, OperationResult<Product>>
{
    private readonly IUnitOfWork _unitOfWork;
    private readonly IEventPublisher _eventPublisher;
    private readonly ProductService _productService;

    public DisableProductCommandHandler(IUnitOfWork unitOfWork,
    ...
    public async Task<OperationResult<Product>> Handle(DisableProductCommand request,
        CancellationToken cancellationToken)
    {
        ...
        try
        {
            ...
            var productEvent = new ProductDisableEvent(product.Id);
